  ...
  return (
    <section>
      <div class="container">
        <div class="row pt-5">
          <div class="col-12">
            <h3 class="text-uppercase mb-4 text-center">Services</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-3 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-3 d-flex align-items-stretch">
            <div class="card">
              <Image src={Image1} class="card-img-top img-fluid" alt="Card Image" />
              <div class="card-body d-flex flex-column">
                <h5 class="card-title">Tube Well Drilling</h5>
          ...
          <div class="col-lg-3 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-3 d-flex align-items-stretch">
            <div class="card">
              <Image src={Image2} class="card-img-top img-fluid" alt="Card Image" />
              <div class="card-body d-flex flex-column">
                <h5 class="card-title">Ground Water Investigation</h5>
          ...
          <div class="col-lg-3 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-3 d-flex align-items-stretch">
            <div class="card">
              <Image src={Image3} class="card-img-top img-fluid" alt="Card Image" />
              <div class="card-body d-flex flex-column">
                <h5 class="card-title">Rain Water Harvesting Solution</h5>
          ...
          <div class="col-lg-3 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-3 d-flex align-items-stretch">
            <div class="card">
              <Image src={Image4} class="card-img-top img-fluid" alt="Card Image" />
              <div class="card-body d-flex flex-column">
                <h5 class="card-title">Water Refining Treatment</h5>
