            ...
            <div class="row g-5">
                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        ...
                        <p className='paragraph'>Mahalaxmi Borewell  is a one roof platform where you can find all the services related to borewell drilling in-spite of the diverse needs and locations.
                        We, Mahalaxmi Borewell, situated at Udaipur, Rajasthan are recognized as one of the most reliable multi-disciplinary drilling contractors.</p>
